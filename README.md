...
If I have to say, the closest thing to this is the specialized CPTPP of these softwares. Technically everything is contained in `cptpp-dashboard`, but I added the three other repos to make sure the maths are transparent and security is rock solid:
